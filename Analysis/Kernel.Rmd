...
library('vcd')                                              # for Odds Ratio and Woolf test of contigency tables
```
...
```{r}
mytable <- xtabs(~full[1:891,]$Sex + full[1:891,]$Survived + full[1:891,]$Agebincmb, data=full)
ftable(mytable)
mantelhaen.test(mytable)
oddsratio(mytable, log=TRUE) 
woolf_test(mytable)
#Those that have died, have a statisticaly higher male proportion than females, after controlling for the different age groups
```
