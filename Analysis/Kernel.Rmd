...
#WIP to create stacked bar chart
...
##Sanbox for histogram with normal curve##
##########################################
...
#works to create two density plots, one with a random normal 1000 samples one with a normal density curve
z <- rnorm(1000)
...
#will create a normally distributed recursive sample with mean 40        
...
set.seed(8)
x <- mysamp(n=1000, m=40, s=10, lwr=0, upr=80, rounding=2)
#http://stackoverflow.com/questions/19343133/setting-upper-and-lower-limits-in-rnorm
