...
* Missing Not at Random (MNAR) - there is a difference between those missing and those observed, AND this CANNOT be explained by other variables in the data, this would mean missing data is related to things we have not observed.  For instance if we had missing fare data and this was related to the persons social class. There is a relationship between the value of the missing data and why it is missing
